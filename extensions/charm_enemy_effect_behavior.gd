...
var _original_additional_material: ShaderMaterial
var child_charmed = false

###新功能####
func charm_proj(proj: EnemyProjectile):
	_original_additional_material = proj._sprite.material
...
func uncharm_proj(proj: EnemyProjectile):
	...
	proj.set_sprite_material(_original_additional_material)
